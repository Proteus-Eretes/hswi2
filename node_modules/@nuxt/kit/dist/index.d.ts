...
import { Configuration, Compiler, Stats, WebpackPluginInstance } from 'webpack';
...
interface ConfigSchema$1 {
  ...
  */
   ...
   * @default ["/project/node_modules","/home/runner/work/framework/framework/packages/kit/node_modules"]
   * 
   * @example
   * ```js
   * export default {
 ...
 * Requires Nuxt 2.13+
 */
declare function addComponentsDir(dir: ComponentsDir): void;
 ...
 */
declare function checkNuxtCompatibilityIssues(constraints: NuxtCompatibilityConstraints, nuxt?: Nuxt): NuxtCompatibilityIssues;
/**
 * Check version constraints and throw a detailed error if has any, otherwise returns true
 */
declare function ensureNuxtCompatibility(constraints: NuxtCompatibilityConstraints, nuxt?: Nuxt): true;
/**
 * Check version constraints and return true if passed, otherwise returns false
 */
declare function hasNuxtCompatibility(constraints: NuxtCompatibilityConstraints, nuxt?: Nuxt): boolean;
...
declare function createModuleContainer(nuxt: Nuxt): {
    nuxt: Nuxt;
    options: NuxtOptions;
    /**
    ...
    addLayout(tmpl: NuxtTemplate, name: string): void;
    /**
    ...
    /** Adds a new server middleware to the end of the server middleware array. */
    addServerMiddleware: typeof addServerMiddleware;
    ...
    requireModule: typeof installModule;
    /** Registers a module. moduleOpts can be a string or an array ([src, options]). */
    addModule: typeof installModule;
};
declare type ModuleContainer = ReturnType<typeof createModuleContainer>;

interface NuxtCompatibilityConstraints {
    /**
...
interface ConfigSchema extends ConfigSchema$1 {
    hooks: NuxtHooks;
 ...
 */
declare function loadEnv(rootDir: string, options?: LoadNuxtConfigOptions['envConfig']): Promise<void>;
