...
const getSSRApp = cachedImport(() => Promise.resolve().then(() => require("#build/dist/server/server.mjs")));
const publicPath = _config.publicConfig.app && _config.publicConfig.app.assetsPath || process.env.PUBLIC_PATH || "/_nuxt";
