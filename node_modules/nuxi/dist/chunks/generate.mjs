...
import { i as isexe_1, s as signalExit } from './index3.mjs';
...
Object.defineProperty(signals,"__esModule",{value:true});signals.getSignals=void 0;var _os$1=require$$0$3;
...
const generate = defineNuxtCommand({
  ...
  async invoke(args) {
    ...
    if (isNuxt3(nuxt)) {
      ...
      await nuxt.close();
      await execa$1("npx", ["nuxt", ...process.argv.slice(2)], { stdio: "inherit" });
    }
  }
});
