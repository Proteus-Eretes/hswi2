...
export default defineStore("fields", () => {
  ...
  const groupedByBlock = reactive<{ [id: number]: Field[] }>({})
  ...
  async function load(): Promise<void> {
    try {
      ...
      const fieldEntities = loadedFields.reduce((entities: { [id: string]: Field }, field: Field) => {
